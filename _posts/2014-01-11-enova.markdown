...
There are two distinct subsets in our data! Given more time, we would have developed separate models for each subset. This would have definitely improved performance. 

Though we didn't exploit this observation, I'm glad we discovered it. In hindsight, I would have been embarrassed to have missed a pattern this glaring.
...
3. __Don't rush to code.__ This results from following lessons 1 and 2. Nelson and I spent the first of the four hours planning. By then, everyone else was coding. Even then, we made most of our insights in the last 30 minutes while plotting graphs for the presentation. By then, it was too late to exploit these insights. In hindsight, we should have put off coding and spent more time exploring and planning. 
